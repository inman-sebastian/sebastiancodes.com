        ...
        <main className="flex-1 flex flex-col lg:py-22">
          ...
          >
            ...
            <div className="grid grid-cols-1 pt-8 pb-10 gap-6 lg:py-0">
              ...
              <Card type="testimonial" authorName="Paulette Carter" authorCompany="PCD Group">
          ...
          <footer className="text-sm mt-22">Copyright © 2025 Sebastian Inman. All rights reserved.</footer>
        </main>
      </Container>
    </>
  );
